...
documentation: [Flutter & Java JDK Setup Guide](https://wrteam-in.github.io/common_app_doc/GeneralSettings/basicsetup)
...
1. Download Flutter SDK version 3.38.6 (stable channel) from the official Flutter website:
