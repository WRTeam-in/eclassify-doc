...
:::important
For authentication setup and URL scheme configuration, please refer to our [comprehensive guide](https://marketplace.wrteam.in/docs/flutter-common-doc/GeneralSettings/firebase/#-for-ios-authentication-setup). This step is crucial for enabling Apple Sign-In in your iOS app.
:::
